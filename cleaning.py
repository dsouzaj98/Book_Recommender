...
#goodbooks data
books_data=pd.read_csv("data/goodbooks/books.csv")
tags_data=pd.read_csv('data/goodbooks/book_tags.csv')
ratings_data=pd.read_csv('data/goodbooks/ratings.csv')
book_tags=pd.read_csv('data/goodbooks/tags.csv')
